...
#[AsCommand(name: 'make:vue-delete-modal')]
class VueDeleteModalMakeCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'make:vue-delete-modal';
     ...
     * @var string
     */
    protected $description = 'Create a new vue Delete modal file';
    ...
    protected function getPath($name)
    {
        ...
        return base_path("resources/js/modals/modals/" . strtolower($name) . '/' . $name. "DeleteModal.vue");
    }
    ...
    {
        return base_path('vendor/pderas/templar/src/stubs/vue-delete-modal.stub');
    }
